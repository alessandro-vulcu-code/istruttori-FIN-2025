...
**A dorso le braccia si muovono**

- [ ] A. In sequenza, prima uno e poi l’altro
- [ ] B. Liberamente
- [ ] C. Quando un braccio entra l’altro è a metà recupero
- [x] D. In opposizione, un braccio entra in acqua e l’altro esce

## 267 - La scuola nuoto

**A stile libero, dopo la partenza e dopo ogni virata, per quanto è consentito rimanere in completa immersione?**
...
**Affinché un bambino acquisisca un buon galleggiamento bisogna**
...
- [x] B. L’ambientamento è legato a caratteristiche psicologiche, l’acquaticità a caratteristiche tecniche
...
**Ambientamento significa**

- [ ] A. Rimanere molto tempo in acqua
- [x] B. Acquisire un rapporto naturale con l’acqua e stare bene in acqua
- [ ] C. Nuotare veloci
- [ ] D. Entusiasmo e amicizia

## 271 - La scuola nuoto

**Anelli della catena della sopravvivenza nel giusto ordine**
...
- [x] D. Attivazione del 118 – RCP – defibrillazione – trattamenti avanzati

## 272 - La scuola nuoto

**BLS (Basic Life Support) è**
...
- [x] C. L’insieme delle tecniche da usare nella rianimazione
- [ ] D. il complesso delle differenti nuotate di base da usare nell’avvicinamento e nel trasporto del pericolante

## 273 - La scuola nuoto

**Caratteristiche della respirazione in acqua**

- [ ] A. Si espira e si inspira dal naso
- [ ] B. Si inspira e si espira dalla bocca
- [ ] C. Si inspira dal naso e si espira dalla bocca
- [x] D. Si inspira dalla bocca si espira dalla bocca o dal naso

## 274 - La scuola nuoto

**Ciambelle, braccioli, tavolette, tubi, ecc., sono**

- [x] A. Sussidi didattici
...
**Come ci si comporta in caso di emergenza che renda necessario evacuare la piscina?**
...
- [x] D. Far uscire gli allievi mettendoli in fila, contandoli e accompagnandoli verso l’uscita d’emergenza

## 276 - La scuola nuoto

**Come comportarsi nel caso di una forte emorragia esterna?**

- [ ] A. Non fare nulla
- [ ] B. Mettere a sedere l’infortunato con del ghiaccio sulla testa
- [ ] C. Perdere conoscenza
- [x] D. Tamponare la ferita e avvisare il pronto soccorso

## 277 - La scuola nuoto

**Come si allertano i soccorsi del 118?**

- [x] A. Si telefona fornendo i propri dati anagrafici, località e caratteristiche dell’incidente
...
**Come si costruisce un progetto didattico?**
...
- [x] D. Definendo degli obiettivi appropriati e scegliendo esercizi orientati per raggiungerli

## 279 - La scuola nuoto

**Come si costruisce una lezione?**

- [x] A. Stabilendo una scaletta usando degli indicatori e immaginando esercizi adeguati agli obiettivi
...
**Come si effettua la selezione dei talenti**

- [ ] A. Attraverso considerazioni del genitore
- [x] B. Attraverso gare sociali, istruttori e allenatori
- [ ] C. Attraverso desideri personali
- [ ] D. Attraverso il consiglio dei compagni

## 281 - La scuola nuoto

**Come si può alzare il livello di sicurezza in piscina?**

- [x] A. Stendendo un protocollo della sicurezza a cui tutti devono attenersi
...
**Con che frequenza si deve inspirare nuotando a dorso?**

- [ ] A. Ogni 4 bracciate
- [ ] B. Ogni 3 bracciate
- [x] C. Ogni 2 bracciate
- [ ] D. Ogni bracciata

## 283 - La scuola nuoto

**Contenuti della ginnastica prenatatoria per la fascia di età della scuola primaria, sono**

- [ ] A. Ginnastica analitica
- [ ] B. Ginnastica con piccoli attrezzi
- [ ] C. Forza massimale
- [x] D. Circuiti e giochi

## 284 - La scuola nuoto

**Cos’è il GUG?**

- [x] A. Un organo tecnico della F.I.N.
...
- [x] A. Settore istruzione tecnica
...
- [x] D. Un organo tecnico della FIN

## 287 - La scuola nuoto

**Cos’è importante nella nuotata a crawl, dorso e farfalla?**

- [ ] A. Le pause nelle azioni
- [x] B. La continuità delle azioni, evitando pause a fine ed inizio bracciata
...
- [x] D. Un sistema per immaginare e seguire un percorso formativo

## 289 - La scuola nuoto

**Cos’è un protocollo della sicurezza?**

- [ ] A. La procedura BLS
- [x] B. Un insieme di norme e comportamenti standard a cui attenersi
...
**Cosa rappresentano queste sigle: FINA, LEN, ##### COMEN, COLAN, ILS, ILSE?**
...
- [x] D. Federazioni e istituzioni sportive alle quali la FIN è affiliata

## 293 - La scuola nuoto

**Cosa si fa quando un allievo dice di stare male?**

- [ ] A. Gli si dice che non è nulla
- [x] B. Si valuta la situazione
- [ ] C. Si grida aiuto
- [ ] D. Si allerta immediatamente il STE

## 294 - La scuola nuoto

**Cosa si prevede che un bambino sappia fare nella prima fase di ambientamento?**

- [ ] A. Si sappia tuffare dal bordo autonomamente e riemerge da solo
- [x] B. Abbia un buon rilassamento corporeo
- [ ] C. Sappia spostarsi lungo il bordo autonomamente
- [ ] D. Nuoti per 25m con tecnica a piacere senza interruzioni

## 295 - La scuola nuoto

**Da che cosa può essere determinata la squalifica per una virata a rana?**

- [x] A. Mani che toccano il muro in modo non contemporaneo
...
**Definizione di ambientamento.**

- [ ] A. Il periodo in cui un allievo prende confidenza con l’ambiente acquatico
- [ ] B. Il momento dell’iscrizione a un corso
- [x] C. La lunga esperienza motoria che porta un allievo a padroneggiare i suoi movimenti in acqua, vivendo desideri, superando paure, incontrando relazioni positive e scoprendo nuove cognizioni di sé
...
- [x] A. Effetto lesivo provocato su un organismo vivente da parte di un’azione meccanica esterna
...
**Dopo ogni partenza ed ogni virata, tranne in uno stile, a quanti metri deve emergere dall’acqua il nuotatore e con quale parte del corpo?**

- [x] A. Entro 15 metri con il capo
...
**Dopo una lunga esposizione ai raggi solari a capo scoperto, potrebbe verificarsi**
...
**Durante il recupero delle gambe a rana, quale parte del corpo provoca il maggior attrito frontale?**
...
**Durante l’ambientamento è importante**

- [x] A. Far superare fastidi fobie e paure
...
**Durante l’apprendimento dei fondamentali di pallanuoto gli errori sono da imputare più frequentemente a**

- [ ] A. Un’errata presentazione del modello visivo
- [x] B. Un’errata percezione di tutti i feed- back da parte dell’allievo
- [ ] C. Un uso improprio dell’analizzatore visivo
- [ ] D. All’approfondimento del gesto

## 303 - La scuola nuoto

**Durante la fase di ambientamento l’allievo**

- [ ] A. Impara a nuotare
- [x] B. Sfrutta inizialmente gli schemi motori terrestri nell’ambiente acquatico
- [ ] C. Sfrutta da subito gli schemi motori acquatici
- [ ] D. Deve fare esercizi di coordinazione

## 304 - La scuola nuoto

**Durante la nuotata è normale inspirare attraverso**
...
**Durante la prima lezione, in fase di ambientamento, l’istruttore come prima cosa**

- [ ] A. Deve insegnare subito il galleggiamento
- [ ] B. Deve far ambientare i propri allievi in acqua alta
- [x] C. Deve provvedere a far conoscere il nuovo ambiente (spogliatoi, piscina, istruttore ecc.) ai nuovi arrivati.
- [ ] D. Deve insegnare la respirazione nella forma più ludica possibile

## 306 - La scuola nuoto

**Durante le sedute di ginnastica educativa e prenatatoria, per un gruppo di bambini in età della scuola primaria, è fondamentale sviluppare e affinare**

- [ ] A. Forza e resistenza.
- [x] B. Capacità di: controllo motorio, apprendimento, capacità di adattamento e trasformazione del movimento.
- [ ] C. Schemi motori di base
- [ ] D. Orientamento

## 307 - La scuola nuoto

**Durante una lezione la dimostrazione dell’insegnante deve avvenire**

- [ ] A. Di spalle agli allievi fuori dall’acqua
- [x] B. A specchio fuori dall’acqua
- [ ] C. Di spalle gli allievi su un rialzo
- [ ] D. Solamente a voce

## 308 - La scuola nuoto

**È importante che l’istruttore entri in acqua durante l’impostazione dello scivolamento sul dorso in vasca piccola?**
...
- [x] D. Sì, perché trasmette sicurezza all’allievo

## 309 - La scuola nuoto

**È un errore più grave nella nuotata a farfalla**

- [x] A. Fermare le braccia davanti alla testa per effettuare il secondo colpo di gambe
...
- [x] D. Presa, trazione, spinta, recupero

## 311 - La scuola nuoto

**Figure necessariamente presenti in una Scuola nuoto federale**

- [x] A. Direttore sportivo- coordinatore – istruttori
...
**Funzioni della gambata nel crawl**

- [ ] A. Propulsivo e di riequilibrio
- [x] B. Propulsivo, di galleggiamento e stabilizzante
- [ ] C. Recupero, presa, trazione e spinta
- [ ] D. Ristoro muscolare

## 313 - La scuola nuoto

**Gli ausili didattici vanno utilizzati in modo maggiore e continuativo per**

- [ ] A. La didattica delle nuotate
- [ ] B. I galleggiamenti statici
- [ ] C. Il potenziamento a secco
- [x] D. Il lavoro di tipo multilaterale

## 314 - La scuola nuoto

**Gli esercizi nella fase del consolidamento devono essere**

- [ ] A. Brevi e poco differenziati
- [ ] B. Brevi e molto differenziati
- [x] C. Lunghi e ripetitivi
- [ ] D. Lunghi e molto differenziati

## 315 - La scuola nuoto

**Gli esercizi nella fase della conoscenza devono essere**

- [ ] A. Brevi e poco differenziati
- [x] B. Brevi e molto differenziati
- [ ] C. Lunghi e ripetitivi
- [ ] D. Lunghi e molto differenziati

## 316 - La scuola nuoto

**Gli esercizi nella fase della scoperta devono essere**

- [x] A. Brevi e poco differenziati
- [ ] B. Brevi e molto differenziati
- [ ] C. Lunghi e ripetitivi
- [ ] D. Lunghi e molto differenziati
...
**Gli obiettivi affettivi indicano**

- [ ] A. Ciò che l’allievo deve sapere
- [x] B. Ciò che l’allievo deve provare davanti ad una situazione
- [ ] C. Come l’allievo si deve comportare
- [ ] D. I brevetti tecnici

## 318 - La scuola nuoto

**Gli obiettivi cognitivi indicano**

- [x] A. Ciò che l’allievo deve sapere
...
**Gli obiettivi dell’educazione respiratoria sono**

- [ ] A. Ossigenare il sangue
- [x] B. Controllo delle apnee, delle inspirazioni/espirazioni in acqua
...
- [x] A. Obiettivi esposti in termini generali che si possono raggiungere in tempi lunghi
...
- [x] B. Obiettivi espressi con una certa specificità che si possono ottenere in periodi valutabili in mesi
- [ ] C. Obiettivi espressi in operazioni concrete raggiungibili nei tempi di una unità didattica
- [ ] D. I brevetti tecnici

## 322 - La scuola nuoto

**Gli obiettivi motori indicano**

- [ ] A. Ciò che l’allievo deve sapere
- [x] B. Ciò che l’allievo deve saper fare
- [ ] C. Come l’allievo si deve comportare
- [ ] D. I brevetti tecnici
...
- [x] D. Obiettivi espressi in operazioni concrete raggiungibili nei tempi di una unità didattica

## 324 - La scuola nuoto

**Gli organi della FIN sono**

- [ ] A. Gli organi periferici e centrali
- [ ] B. Gli organi centrali ed internazionali
- [ ] C. Gli organi ministeriali
- [x] D. Gli organi centrali, periferici e di giustizia

## 325 - La scuola nuoto

**Grazie a quale principio fisico il corpo umano galleggia in acqua?**

- [ ] A. Principio di gravità
- [ ] B. Principio di azione e reazione
- [x] C. Principio di Archimede
- [ ] D. Principio di Bernoulli

## 326 - La scuola nuoto

**I livelli tecnici minimi previsti dalla scuola nuoto federale sono: #####**
...
**I prerequisiti per l’insegnamento della virata a crawl sono**

- [x] A. Saper effettuare la capovolta
...
**I principali obiettivi della ginnastica educativa sono**
...
- [x] D. Sviluppo degli schemi motori di base, sviluppo dello schema corporeo, miglioramento delle capacità coordinative

## 329 - La scuola nuoto

**Il coordinatore della scuola nuoto**

- [ ] A. Rappresenta la società, definisce gli obiettivi sulla base delle risorse disponibili
- [x] B. Pone in essere le indicazioni della direzione
- [ ] C. Programma e attua la preparazione delle squadre agonistiche
- [ ] D. Sviluppa autonomamente il proprio percorso didattico

## 330 - La scuola nuoto

**Il crawl prevede movimenti**
...
**Il galleggiamento statico può essere definito come**
...
- [x] D. La posizione di equilibrio tra baricentro e centro di gravità

## 333 - La scuola nuoto

**Il movimento degli arti inferiori, nella nuotata a rana, si distingue in (nell’ordine)**

- [ ] A. Scivolamento, spinta e recupero
- [x] B. Flessione, spinta e scivolamento
- [ ] C. Flessione, scivolamento e spinta
- [ ] D. Presa, trazione, recupero

## 334 - La scuola nuoto

**Il raggiungimento degli obiettivi dell’ambientamento si deducono dal fatto che**

- [ ] A. Il soggetto in acqua non ha paura
- [x] B. Il soggetto in acqua è rilassato e padroneggia in modo elementare il suo corpo
- [ ] C. Il soggetto in acqua si sposta dal bordo alla corsia in maniera autonoma
- [ ] D. Il soggetto consegue uno o più brevetti

## 335 - La scuola nuoto

**Il recupero delle braccia a rana è**
...
**Il recupero delle braccia nella nuotata a farfalla inizia**

- [ ] A. Durante la respirazione
- [ ] B. All’inizio della trazione
- [x] C. Alla fine della spinta
- [ ] D. Durante la fase di scivolamento

## 337 - La scuola nuoto

**Il rollio è un movimento di spalle e busto sull’asse sagittale, si esegue**

- [ ] A. In fase di partenza
- [ ] B. Nella rana
- [x] C. Nello stile libero e nel dorso
- [ ] D. Nella farfalla

## 338 - La scuola nuoto

**Il torpedo è un attrezzo che si usa**
...
- [x] B. Una nuotata a crawl, ma con le gambe che effettuano un colpo di gambe a rana o sforbiciano
- [ ] C. Una nuotata a dorso con l’azione delle braccia simultanea
- [ ] D. Una nuotata a farfalla con le gambe a rana

## 340 - La scuola nuoto

**In caso di attivazione del STE cosa si deve comunicare, nell’ordine?**

- [x] A. Luogo, condizioni del pericolante e recapito telefonico
...
**In caso di incidente in piscina quale numero telefonico è necessario usare per innescare la cosiddetta catena della sopravvivenza? #####**
...
**In che cosa consiste la revisione della programmazione didattica?**
...
- [x] D. Rielaborazione degli elementi che si ritengono migliorabili

## 343 - La scuola nuoto

**In che posizione si trova il gomito, rispetto alla mano, nel recupero a stile libero?**
...
**In quale nuotata non c’è il limite dei 15 metri subacquei in fase di partenza e dopo ogni virata?**
...
**In quale ordine si svolge la staffetta 4x100 metri mista?**

- [ ] A. Farfalla – dorso – rana – stile libero
- [x] B. Dorso – rana – farfalla – stile libero
- [ ] C. Dorso - farfalla – rana - stile libero
- [ ] D. Stile libero – dorso – rana - farfalla

## 346 - La scuola nuoto

**In quali nuotate si esegue il rollio?**
...
**In termini giuridici, chi è responsabile?**

- [x] A. Chi assume su di sé l’onere del rischio e delle conseguenze provocate dal proprio comportamento
...
**In un ciclo completo di braccia a farfalla, quante battute di gambe si eseguono normalmente?**
...
**In un massaggio cardiaco si comprime ritmicamente il torace ad una frequenza di**

- [ ] A. 10 - 15 colpi al minuto
- [ ] B. 30 - 50 colpi al minuto
- [x] C. 80 - 100 colpi al minuto
- [ ] D. 150 - 180 colpi al minuto

## 350 - La scuola nuoto

**In una gara a stile libero un concorrente può rimanere in completa immersione**

- [ ] A. Per tutta la distanza che deve coprire
- [ ] B. Mai
- [ ] C. Alla partenza ed alle virate, per un massimo di 10 metri
- [x] D. Alla partenza ed alle virate, per un massimo di 15 metri

## 351 - La scuola nuoto

**In una gara di misti individuali o di staffetta mista, la frazione a stile libero è intesa come**

- [ ] A. Nuotare tassativamente a crawl
- [ ] B. Nuotare uno stile qualsiasi
- [ ] C. Nuotare uno stile qualsiasi anche subacqueo
- [x] D. Nuotare uno stile che non sia la farfalla, il dorso, la rana

## 352 - La scuola nuoto

**In una gara di nuoto quante partenze sono previste?**

- [ ] A. Due (la seconda comunque valida)
- [x] B. Una (comunque valida)
- [ ] C. Tre (la terza comunque valida)
- [ ] D. Quattro (la quarta comunque valida)

## 353 - La scuola nuoto

**In una gara di stile libero individuale è possibile nuotare**

- [x] A. In qualsiasi modo
- [ ] B. Solo a crawl
...
**In una gara, in quali nuotate è possibile fermarsi in piedi sul fondo della vasca senza incorrere in una squalifica?**

- [ ] A. Non è possibile in nessuno stile
- [x] B. Solo nello stile libero
- [ ] C. Solo stile libero e dorso
- [ ] D. Nella rana

## 355 - La scuola nuoto

**Indica alcuni segnali che evidenziano la paura**

- [x] A. Stato di tensione generale, rigidità, silenzio, ritardo nelle reazioni, esagerata percezione del freddo
...
**Indica le principali cause di paura**

- [ ] A. Esperienza diretta negativa dell’acqua
- [x] B. Esperienza diretta negativa dell’acqua, esperienze indirette, imitazione dei comportamenti di altri
- [ ] C. Esperienze raccontate circa la pericolosità dell’acqua
- [ ] D. Tradizioni familiari

## 357 - La scuola nuoto

**Inserire il gioco durante la lezione significa**

- [x] A. Utilizzarlo come strumento didattico
...
**L’acronimo che indica la procedura di rianimazione è: #####**
...
**L’ambientamento in acqua alta**

- [x] A. Stimola maggiormente la ricerca degli equilibri
...
- [x] D. È la fase fondamentale della scuola nuoto

## 361 - La scuola nuoto

**L’analisi della situazione iniziale è la fase della programmazione didattica nella quale**

- [x] A. Si analizza il contesto per fare delle scelte
...
**L’insegnamento delle nuotate a secco**
...
- [x] D. È inutile, vista la posizione del corpo e la diversa densità dell’aria rispetto all’acqua

## 363 - La scuola nuoto

**L’inspirazione nella nuotata a rana si effettua**

- [x] A. Al termine della fase di trazione
...
**L’istruttore deve stimolare la fantasia e l’attenzione del bambino attraverso**
...
- [ ] C. Vincere
- [x] D. Sapere, saper fare, saper far fare, saper essere, saper comunicare

## 366 - La scuola nuoto

**L’istruttore nella fase del consolidamento dovrebbe**

- [ ] A. Essere attento alla relazione
- [ ] B. Concentrarsi sull’esercizio
- [ ] C. Lavorare anche a secco
- [x] D. Vigilare sull’esecuzione corretta

## 367 - La scuola nuoto

**L’istruttore nella fase della conoscenza dovrebbe**

- [ ] A. Essere attento alla relazione
- [x] B. Concentrarsi sull’esercizio
- [ ] C. Lavorare anche a secco
- [ ] D. Vigilare sull’esecuzione corretta

## 368 - La scuola nuoto

**L’istruttore nella fase della scoperta dovrebbe**

- [x] A. Essere attento alla relazione
- [ ] B. Concentrarsi sull’esercizio
- [ ] C. Lavorare anche a secco
- [ ] D. Vigilare sull’esecuzione corretta
...
**L’obiettivo di una programmazione deve essere**

- [x] A. Formulato in positivo
...
**L’obiettivo principale di un corso di nuoto è**

- [ ] A. Sviluppare le capacità condizionali
- [ ] B. Acquisire una postura corretta
- [ ] C. Massimizzare la performance
- [x] D. Sviluppare capacità senso-percettive e coordinative speciali

## 371 - La scuola nuoto

**L’organizzazione della singola lezione**

- [x] A. Non deve mai avere il requisito dell’estemporaneità
...
**L’organizzazione didattica della lezione è costituita da**

- [ ] A. Scoperta, conoscenza e consolidamento
- [ ] B. Presa, trazione, spinta e recupero
- [x] C. Introduzione, consolidamento, apprendimento e conclusiva/ricreativa
- [ ] D. Pianificazione degli strumenti e dei metodi

## 373 - La scuola nuoto

**L’organizzazione si può definire come**

- [x] A. Una procedura flessibile che controlla e verifica il lavoro per stabilire tempi e modi dell’intervento
...
- [x] D. Una nuotata sul fianco

## 375 - La scuola nuoto

**La fabulazione è**

- [x] A. L’arte di creare e raccontare storie
...
**La fase propulsiva più significativa della gambata nel crawl è**

- [ ] A. La fase ascensionale
- [ ] B. La fase terminale
- [x] C. La fase discendente
- [ ] D. Nessuna delle risposte precedenti

## 378 - La scuola nuoto

**La fase propulsiva più significativa della gambata nel dorso è**

- [x] A. La fase ascensionale
...
**La forza di gravità in acqua**

- [ ] A. Non si manifesta
- [x] B. Si manifesta ed è bilanciata dalla spinta idrostatica
- [ ] C. Si manifesta ed è superiore a quella riscontrata sulla terra
- [ ] D. Risulta utile per il galleggiamento

## 380 - La scuola nuoto

**La frustata verso il basso della gambata a farfalla provoca**

- [x] A. Il sollevamento del bacino del nuotatore
...
- [x] A. È proponibile in tutte le fasce d’età
...
**La nuotata a farfalla prevede un’azione braccia/gambe**
...
**La peculiarità tecnica del piede a martello è caratteristica del colpo di gambe a**
...
**La posizione laterale di sicurezza si adotta quando la persona da soccorrere**

- [ ] A. Non è cosciente, presenta spontanea attività cardiaca ed assenza di quella respiratoria
- [ ] B. Non è più in vita
- [x] C. Non è cosciente ma presenta spontaneamente attività respiratorie e cardiache
- [ ] D. È cosciente ma denuncia difficoltà respiratorie

## 385 - La scuola nuoto

**La pratica della pallanuoto favorisce**

- [x] A. La socializzazione e la cooperazione, lo sviluppo di abilità motorie
...
**La respirazione in acqua è**

- [ ] A. Inconsapevole e automatica
- [ ] B. Normale e disinvolta
- [ ] C. Problematica e angosciante
- [x] D. Forzata e cosciente

## 388 - La scuola nuoto

**La respirazione nella nuotata a rana avviene**

- [ ] A. Terminata la fase di presa
- [ ] B. All’inizio della trazione
- [x] C. Tra il termine della trazione e l’inizio del recupero
- [ ] D. Ogni due cicli di bracciata

## 389 - La scuola nuoto

**La scelta degli esercizi è la fase della programmazione didattica in cui**
...
- [x] C. Si scelgono le strategie migliori per arrivare agli obiettivi
- [ ] D. Si valutano i risultati ottenuti

## 390 - La scuola nuoto

**La scelta dei mezzi e dei metodi è la fase della programmazione didattica in cui**
...
**La singola lezione di nuoto in quali fasi è suddivisa?**

- [ ] A. Introduzione, ambientazione, apprendimento e conclusione
- [x] B. Introduzione, consolidamento, apprendimento e conclusione
...
**La sommersione e la conseguente asfissia, con inondazione polmonare si dice**
...
**Le distanze olimpiche a stile libero sono**

- [ ] A. 200 e 400 metri
- [ ] B. 4x100 e 4x200 metri
- [ ] C. 50 e 100 metri
- [x] D. Tutte le risposte precedenti sono corrette

## 394 - La scuola nuoto

**Le fasi dell’apprendimento sono**

- [x] A. Scoperta, conoscenza e consolidamento
...
**Le remate del nuoto sincronizzato nella scuola nuoto sono utili per**

- [ ] A. Prendere confidenza con l’acqua
- [x] B. Affinare la sensibilità
...
- [x] D. Movimenti degli arti superiori utili per il mantenimento dell’equilibrio

## 400 - La scuola nuoto

**Lo scivolamento nella nuotata a rana ha una funzione**
...
**Lo strumento più adatto per vincere la paura è**
...
**Mettere nel giusto ordine le seguenti fasi di un processo didattico**

- [x] A. Analisi della situazione di partenza, definizione degli obiettivi, scelta di mezzi e metodi, valutazione finale
...
**Nel bambino la paura dell’acqua viene rimossa con**

- [ ] A. L’entrare solo quando lo chiede
- [x] B. Esperienze positive
- [ ] C. Spiegazioni dell’istruttore
- [ ] D. La presenza dei genitori

## 404 - La scuola nuoto

**Nel crawl la coordinazione classica per ogni ciclo di braccia prevede**

- [x] A. Sei battute di gambe
...
**Nel crawl la fase più efficace agli effetti propulsivi è**
...
**Nel crawl, la bracciata si effettua a**

- [x] A. Gomito flesso sia nel recupero che nella fase subacquea
...
- [x] D. Il recupero avviene fuori dall’acqua, con il braccio flesso, i muscoli decontratti , il gomito alto e la mano che sfiora l’acqua
...
- [x] C. È importante la posizione del gomito alto e avanzato nella fase di trazione
...
- [x] D. Tra spinta e recupero ci deve essere continuità.

## 410 - La scuola nuoto

**Nel dorso è un errore più grave**

- [ ] A. Non effettuare il rollio
- [x] B. Fermare la bracciata lungo i fianchi
- [ ] C. Muovere le gambe a bicicletta
- [ ] D. Nuotare con il capo leggermente sollevato sull’acqua

## 411 - La scuola nuoto

**Nel dorso la bracciata è**

- [ ] A. Gomito flesso sia nella fase aerea che in quella subacquea
- [x] B. Gomito disteso nella fase aerea e flesso in quella subacquea
- [ ] C. Gomito disteso nella fase aerea e in quella subacquea
- [ ] D. Braccio teso

## 412 - La scuola nuoto

**Nel dorso la coordinazione respiratoria**

- [ ] A. Non ha molta importanza in quanto la bocca è sempre fuori dall’acqua e non influisce sul rendimento della nuotata
- [x] B. È corretto ritmarla ed automatizzarla per avere scambio d’aria frequente e assicurare una buona ossigenazione del sangue
...
**Nel dorso, al termine della fase di recupero, come entra in acqua la mano?**

- [ ] A. Con il dorso
- [ ] B. Con il palmo rivolto verso il corpo del nuotatore
- [x] C. Con il palmo della mano rivolto verso l’esterno
- [ ] D. Con il palmo rivolto verso il basso

## 414 - La scuola nuoto

**Nel dorso, le braccia, si trovano sempre in posizione**
...
**Nel dorso, nella fase di spinta è importante**

- [ ] A. Esprimere il minimo della forza
- [x] B. Esprimere il massimo della forza
- [ ] C. Creare una pausa prima dell’inizio del recupero
- [ ] D. Respirare

## 416 - La scuola nuoto

**Nel galleggiamento statico supino in che posizione sono le braccia rispetto al corpo?**
...
**Nel kick (o pull kick) del nuoto sincronizzato il movimento effettuato dalle gambe è**
...
**Nel nuoto sincronizzato la posizione dell’alligatore si effettua**

- [ ] A. Solo da proni
- [ ] B. Solo da supini
- [x] C. Sia proni che supini
- [ ] D. Sul fianco

## 419 - La scuola nuoto

**Nel processo di ambientamento si segue quale ordine?**
...
- [x] D. Immersione-rilassamento-educazione respiratoria-galleggiamento- scivolamento

## 420 - La scuola nuoto

**Nel tuffo, per entrare in acqua in modo dolce (senza spanciare) bisogna**

- [x] A. Flettere la testa in avanti
...
**Nell’ambientamento degli adulti**
...
- [x] D. Si può utilizzare un approccio maggiormente cognitivo

## 422 - La scuola nuoto

**Nell’ambientamento in acqua alta l’istruttore deve essere**

- [x] A. Fuori dall’acqua
- [ ] B. In acqua
...
**Nell’ambientamento quale di queste situazioni è utile?**
...
- [x] D. L’impostazione della attività in maniera giocosa

## 424 - La scuola nuoto

**Nell’ambito della ginnastica educativa e prenatatoria quale è il complesso articolare la cui mobilità è meno stimolabile?**

- [x] A. Complesso articolare del ginocchio
...
**Nell’insegnamento del nuoto il gioco può essere utilizzato come**

- [x] A. Strumento per sviluppare la motricità innata dell’individuo e come mezzo per l’apprendimento di tecniche motorie più complesse
...
**Nell’insegnamento della bracciata a dorso bisogna verificare che**

- [ ] A. La respirazione venga effettuata solo con il naso
- [x] B. Il recupero venga effettuato a braccio disteso e ben alto, con mano rilassata
- [ ] C. La trazione avvenga in profondità, e non lateralmente
- [ ] D. Le gambe si muovano simmetricamente

## 427 - La scuola nuoto

**Nell’insegnamento della farfalla è bene procedere**

- [x] A. Con brevi tratti molto veloci
...
**Nell’insegnamento delle quattro nuotate qual è lo stile che si insegna partendo dall’azione degli arti inferiori?**
...
**Nell’insegnamento di una nuotata cosa è opportuno curare inizialmente?**

- [ ] A. Costanza, precisione e fluidità dei movimenti
- [ ] B. Caratteristiche elementari del movimento
- [x] C. Struttura di base, ritmo ed accoppiamento dei movimenti
- [ ] D. Coordinazione e controllo

## 430 - La scuola nuoto

**Nell’organizzazione di una singola lezione si deve dedicare più tempo a**

- [ ] A. La fase di introduzione
- [ ] B. La fase di consolidamento
- [x] C. La fase di apprendimento
- [ ] D. La fase di rinforzo

## 431 - La scuola nuoto

**Nella bracciata a crawl e a dorso è utile effettuare una pausa nell’azione delle braccia?**
...
**Nella didattica della farfalla s’inizia insegnando**

- [x] A. Il colpo di gambe per ricercare il movimento del bacino
...
**Nella farfalla è obbligatorio eseguire una respirazione**

- [ ] A. Ogni ciclo di bracciata
- [ ] B. Ogni due cicli di bracciata
- [ ] C. Due per ciclo di bracciata
- [x] D. Non c’è nessun obbligo

## 435 - La scuola nuoto

**Nella farfalla il ritmo braccia/gambe va insegnato**
...
- [x] D. Non va insegnato, si definisce con l’evoluzione della nuotata
...
**Nella farfalla, la respirazione avviene**

- [ ] A. Durante il recupero
- [ ] B. Quando se ne ha bisogno
- [ ] C. Durante la fase di appoggio/presa
- [x] D. Durante la fase di spinta

## 438 - La scuola nuoto

**Nella farfalla, terminata la trazione le mani spingono con forza verso**
...
- [x] A. Tutti i movimenti devono essere eseguiti simmetricamente
...
**Nella fase del consolidamento**

- [ ] A. Si incontra il problema da risolvere
- [ ] B. Si sperimenta la soluzione
- [x] C. Si memorizza la soluzione
- [ ] D. Si attende un’illuminazione

## 441 - La scuola nuoto

**Nella fase della conoscenza**

- [ ] A. Si incontra il problema da risolvere
- [x] B. Si sperimenta la soluzione
- [ ] C. Si memorizza la soluzione
- [ ] D. Si attende un’illuminazione

## 442 - La scuola nuoto

**Nella fase della scoperta**

- [x] A. Si incontra il problema da risolvere
- [ ] B. Si sperimenta la soluzione
- [ ] C. Si memorizza la soluzione
- [ ] D. Si attende un’illuminazione
...
- [x] B. Aumenta l’attenzione degli allievi perché aumentano le difficoltà in modo da predisporli alla fase successiva
- [ ] C. Troviamo il nucleo centrale della lezione
- [ ] D. Le nuove informazioni devono essere pianificate e ponderate

## 444 - La scuola nuoto

**Nella fase di trazione della bracciata a crawl il gomito deve essere**

- [ ] A. Più basso rispetto alla mano
- [ ] B. Disteso
- [x] C. Più alto rispetto alla mano
- [ ] D. Più avanti rispetto alla mano

## 445 - La scuola nuoto

**Nella fase iniziale dell’insegnamento della nuotata a crawl è più importante verificare**

- [ ] A. La giusta flessione del gomito durante la trazione
- [x] B. La continuità delle azioni e l’assenza di pause
...
**Nella ginnastica prenatatoria l’allenamento del complesso articolare della colonna vertebrale**
...
- [x] D. È importante perché questa struttura svolge il ruolo di asse portante per il capo, il tronco e per gli arti superiori

## 448 - La scuola nuoto

**Nella ginnastica prenatatoria, si cura**
...
**Nella nuotata a crawl che tipo di movimenti si eseguono sia con gli arti superiori sia con gli arti inferiori?**

- [x] A. Alternato e ciclico
...
**Nella nuotata a crawl, per ottimizzare la tecnica, la mano dovrebbe uscire**

- [ ] A. All’altezza dell’anca
- [x] B. All’altezza della coscia
- [ ] C. All’altezza del ginocchio
- [ ] D. All’altezza della spalla

## 451 - La scuola nuoto

**Nella nuotata a dorso che funzione ha, nella parte finale della spinta, l’azione della mano verso il basso?**
...
- [x] C. Durante tutta la prima fase della bracciata si deve mantenere il gomito più alto della mano e del polso
- [ ] D. Non è importante la continuità del movimento

## 453 - La scuola nuoto

**Nella nuotata a farfalla la fase subacquea della bracciata è formata da**

- [x] A. Appoggio-presa/trazione/ spinta
...
**Nella nuotata a farfalla la respirazione avviene**

- [ ] A. Al termine della fase di recupero
- [x] B. In fase di spinta
- [ ] C. Ogni quattro colpi di gambe
- [ ] D. Nessuna delle risposte precedenti

## 455 - La scuola nuoto

**Nella nuotata a farfalla, i movimenti degli arti superiori e inferiori sono**

- [ ] A. Simmetrici e alternati
- [x] B. Simultanei e simmetrici
- [ ] C. Simultanei e alternati
- [ ] D. Alternati e equilibrati

## 456 - La scuola nuoto

**Nella nuotata a farfalla, il secondo colpo di gambe che funzione ha?**
...
**Nella nuotata a rana, tutti i movimenti degli arti vengono eseguiti**
...
**Nella nuotata con trasporto del pericolante quale tipo di battuta gambe è preferibile utilizzare?**
...
**Nella nuotata dorso l’azione subacquea degli arti superiori si distingue in**

- [x] A. Appoggio/presa, trazione e spinta
- [ ] B. Trazione e spinta
...
**Nella pallanuoto quali sono i mezzi a disposizione per la fase di attacco?**
...
- [x] D. I lanci, gli spostamenti e i tiri

## 466 - La scuola nuoto

**Nella pallanuoto si distinguono due fasi, l’attacco e la difesa.Per l’attacco quali mezzi tecnici deve avere a disposizione la squadra?**

- [ ] A. Marcamento – lancio – tiro
- [ ] B. Forza – resistenza – velocità
- [ ] C. Intercettamento del pallone – marcamento – lancio
- [x] D. Lanci – spostamento – tiro

## 467 - La scuola nuoto

**Nella pallanuoto, quale fondamentale viene utilizzato per le partenze?**
...
**Nella partenza a rana quante battute di gambe a delfino sono ammesse**
...
**Nella programmazione didattica che posto occupa la fase dell’ambientamento?**
...
**Nella progressione didattica per la rana, è importante curare la fase di scivolamento?**

- [ ] A. No, perché lo scivolamento è una dote innata
- [ ] B. Sì, ma solo nelle gare molto veloci
- [x] C. Sì, perché è una caratteristica essenziale dello stile
- [ ] D. No, perché l’avanzamento viene, per la maggior parte, dal colpo di gambe

## 471 - La scuola nuoto

**Nella rana il colpo di gambe è**

- [ ] A. A velocità costante
- [x] B. In accelerazione
- [ ] C. A velocità uniforme
- [ ] D. Pressoché inifluente

## 472 - La scuola nuoto

**Nella rana la fase di recupero delle braccia è**
...
**Nella rana la fase di spinta della bracciata**

- [ ] A. Non è mai presente
- [ ] B. Non è mai assente
- [ ] C. È fondamentale
- [x] D. È presente dopo alcuni particolari movimenti

## 474 - La scuola nuoto

**Nella rana la respirazione è**
...
**Nella rana, la velocità di spostamento della mano è massima durante**

- [ ] A. La Spinta
- [ ] B. La Trazione
- [ ] C. Il recupero
- [x] D. La remata verso l’interno

## 476 - La scuola nuoto

**Nella rana**

- [x] A. La fase attiva della gambata avviene mentre le braccia si estendono in avanti
...
**Nella remata standard del nuoto sincronizzato (galleggiamento supino e braccia flesse lungo i fianchi) per spostarsi in direzione della testa la mano deve essere**

- [ ] A. In flessione palmare con le dita più basse rispetto al polso
- [x] B. In flessione dorsale con le dita più alte rispetto al polso
- [ ] C. Distesa in linea con l’avambraccio
- [ ] D. A martello

## 478 - La scuola nuoto

**Nella virata a dorso, cosa non è consentito fare in posizione prona?**

- [ ] A. Muovere le braccia
- [ ] B. Espirare
- [ ] C. Muovere la testa
- [x] D. Muovere le gambe

## 479 - La scuola nuoto

**Nella virata a rana il tocco delle mani sulla parete come deve avvenire?**
...
- [x] B. È consentito toccare il bordo con le mani a differenti altezze
...
**Nelle gare a farfalla la distanza più lunga è**
...
**Nello stile libero è un errore più grave**
...
- [x] D. Respirare frontalmente invece che lateralmente

## 483 - La scuola nuoto

**Obblighi dell’istruttore**

- [x] A. Diligenza, prudenza, perizia
...
**Organizzare un corso di nuoto significa**
...
- [x] D. Avere ben chiari gli obiettivi che si vogliono perseguire

## 485 - La scuola nuoto

**Per acquisire un efficiente ritmo respiratorio quale di queste capacità bisogna padroneggiare correttamente?**

- [ ] A. Trattenere l’aria
- [x] B. Svuotare completamente i polmoni
- [ ] C. Soffiare bocca/naso
- [ ] D. Nessuna delle precedenti

## 486 - La scuola nuoto

**Per evitare incidenti l’istruttore non deve mai**

- [x] A. Perdere di vista gli allievi
...
- [ ] C. Assentarsi
- [x] D. Tutte le voci precedenti

## 488 - La scuola nuoto

**Per facilitare il galleggiamento gli arti devono essere**

- [ ] A. Rigidamente distesi
- [ ] B. Flessi
- [x] C. Distesi e rilassati
- [ ] D. In continuo movimento per spostare l’acqua

## 489 - La scuola nuoto

**Per il raggiungimento degli obiettivi dell’attività motoria in acqua è consigliato dividere i gruppi**

- [ ] A. Secondo parametri oggettivi (misurazioni antropometriche: altezza, ampiezza braccia, peso, ecc)
- [ ] B. Tra maschi e femmine
- [x] C. Per livello tecnico/capacità
- [ ] D. Per simpatia

## 490 - La scuola nuoto

**Per quale distanza massima è permesso ad un concorrente di rimanere completamente immerso dopo la partenza e dopo ogni virata nelle gare di stile libero dorso e farfalla?**
...
**Per quale motivo è opportuno prevedere l’insegnamento della farfalla come ultimo dei quattro stili?**

- [x] A. Perché necessita di buoni livelli di forza e resistenza
...
**Per quale motivo il recupero delle braccia nella farfalla deve avvenire a braccia distese?**

- [ ] A. Perché è il movimento più semplice
- [x] B. Per evitare un eccessivo innalzamento delle spalle
- [ ] C. Per effettuare una trazione più efficace
- [ ] D. Per non incorrere in una squalifica

## 493 - La scuola nuoto

**Per quali delle seguenti discipline acquatiche è fondamentale l’apprendimento della bicicletta?**
...
- [x] D. Pallanuoto-nuoto sincronizzato- salvamento

## 494 - La scuola nuoto

**Per un buon galleggiamento è fondamentale**
...
**Per un ciclo completo delle braccia a farfalla quante gambate sono necessarie?**
...
**Perché è importante conoscere le tecniche di primo soccorso?**
...
- [x] D. Per effettuare un corretto intervento in caso di necessità

## 497 - La scuola nuoto

**Perché è importante far svolgere agli allievi attività di immersione in acqua fonda?**

- [ ] A. Per imparare a raccogliere gli oggetti dal fondo ed essere capaci di immergere le testa
- [x] B. Per conoscere lo spazio sottostante e sentire che l’acqua spinge verso l’alto
- [ ] C. Perché è piacevole ed insegna a soffiare
- [ ] D. Non è opportuno svolgere questo tipo di esercitazioni

## 498 - La scuola nuoto

**Perché la rana è lo stile più lento?**

- [ ] A. Perché la posizione in acqua è più inclinata rispetto agli altri stili
- [x] B. Perché è uno stile discontinuo
- [ ] C. Perché la testa rompe la superficie dell’acqua ad ogni bracciata
- [ ] D. Perché non c’è la fase di spinta nella bracciata

## 499 - La scuola nuoto

**Principale problema che s’incontra nell’insegnamento del dorso**

- [ ] A. Impostazione della posizione dei piedi
- [x] B. Posizione in acqua seduta
- [ ] C. Spinta delle braccia sufficiente per la propulsione
- [ ] D. Coordinazione tra bracciata e respirazione laterale

## 500 - La scuola nuoto

**Principale problema che s’incontra nell’insegnamento della farfalla**

- [ ] A. Impostazione della posizione dei piedi
- [ ] B. Posizione in acqua seduta
- [x] C. Spinta delle braccia sufficiente per la propulsione
- [ ] D. Coordinazione tra bracciata e respirazione laterale

## 501 - La scuola nuoto

**Principale problema che s’incontra nell’insegnamento della rana**

- [x] A. Impostazione della posizione dei piedi
- [ ] B. Posizione in acqua seduta
- [ ] C. Spinta delle braccia sufficiente per la propulsione
- [ ] D. Coordinazione tra bracciata e respirazione laterale
...
**Principale problema che s’incontra nell’insegnamento dello stile libero**

- [ ] A. Impostazione della posizione dei piedi
- [ ] B. Posizione in acqua seduta
- [ ] C. Spinta delle braccia sufficiente per la propulsione
- [x] D. Coordinazione tra bracciata e respirazione laterale

## 503 - La scuola nuoto

**Principio indispensabile della nuotata a crawl è**

- [ ] A. Il sollevamento della testa per agevolare la respirazione
- [x] B. La continuità delle azioni
...
**Qual è il momento in cui è più probabile possa accadere un incidente in piscina?**

- [ ] A. Nella fase di ginnastica prenatatoria
- [ ] B. Nella fase di riscaldamento in acqua
- [x] C. Nel cambio tra un turno e l’altro
- [ ] D. Durante l’insegnamento delle gambe a rana

## 505 - La scuola nuoto

**Qual è l’elemento indispensabile per eseguire un tuffo?**

- [ ] A. Saltare più in alto possibile
- [x] B. Controllare lo sbilanciamento in avanti
- [ ] C. Saper trattenere il respiro (apnea)
- [ ] D. Tenere il naso chiuso

## 506 - La scuola nuoto

**Qual è l’esercizio che presenta maggiori difficoltà di esecuzione per l’allievo nell’apprendimento dello stile libero?**
...
**Qual è l’obiettivo della scuola nuoto federale?**

- [ ] A. L’insegnamento delle quattro nuotate regolamentari
- [x] B. La strutturazione e la realizzazione di un progetto di total quality
...
**Qual è la corretta sequenza degli stili nelle gare di misti individuali?**

- [ ] A. Dorso – rana – farfalla – crawl
- [ ] B. Crawl – dorso – rana – farfalla
- [x] C. Farfalla – dorso – rana – crawl
- [ ] D. Dorso – farfalla – crawl – rana

## 509 - La scuola nuoto

**Qual è la fase più propulsiva nella nuotata a stile libero?**
...
**Qual è la funzione principale della gambata a stile libero?**
...
**Qual è la parte del corpo che viene maggiormente utilizzata per eseguire le remate?**
...
**Qual è la posizione più corretta della testa nuotando a dorso?**

- [ ] A. Raccolta verso il petto
- [x] B. In linea con il corpo
- [ ] C. Retroflessa
- [ ] D. Girata su un fianco

## 513 - La scuola nuoto

**Qual è la prima forma di galleggiamento che è opportuno insegnare?**
...
**Qual è la progressione corretta delle fasi dell’ambientamento in vasca didattica (acqua bassa)?**
...
- [x] C. Approccio con l’acqua, immersione del viso e respirazione, galleggiamenti, gli scivolamenti, prime propulsioni.
- [ ] D. Approccio con l’acqua, immersione d viso e respirazione, galleggiamenti, prime propulsioni

## 515 - La scuola nuoto

**Qual è la sequenza degli stili nella staffetta 4x100 mista?**
...
**Qual è la successione delle nuotate nella gara dei 100 metri misti individuali?**

- [ ] A. Rana – dorso – delfino – stile libero
- [x] B. Farfalla – dorso – rana – stile libero
- [ ] C. Farfalla – rana – dorso – stile libero
- [ ] D. Stile libero – dorso – rana - farfalla

## 517 - La scuola nuoto

**Qual è lo stile che assicura la massima velocità di spostamento in acqua?**
...
**Qual è un connotato che deve caratterizzare il modello didattico della scuola nuoto per adulti?**

- [x] A. La flessibilità a fronte di particolari problematiche individuali
...
**Quale aspetto della pallanuoto aiuta lo sviluppo dei processi cognitivi?**

- [ ] A. L’utilizzo delle tecniche di pallanuoto
- [ ] B. Lo spirito di squadra
- [ ] C. L’ideazione e attivazione di strategie tattiche
- [x] D. L’ampliamento delle abilità motorie

## 520 - La scuola nuoto

**Quale dei seguenti campi gara è omologabile?**
...
**Quale delle seguenti affermazioni sulla nuotata a dorso non è corretta?**
...
- [x] D. Bacino leggermente affondato

## 522 - La scuola nuoto

**Quale delle seguenti azioni non è causa di squalifica in una gara a rana?**

- [ ] A. Ruotare sul dorso
- [x] B. Superare la linea dei 15 metri durante la fase subacquea di nuotata
...
**Quale fra le seguenti esercitazioni comporta il maggiore rischio di infortunio?**
...
**Quale rapporto esiste nella nuotata a farfalla tra bracciate e gambate? #####**
...
**Quale rapporto esiste nella nuotata a rana tra bracciate e gambate? #####**
...
**Quale segnale indica al nuotatore l’avvicinarsi della parete verticale durante una competizione?**

- [ ] A. L’alternanza di colori nella corsia
- [ ] B. Un segnale acustico
- [x] C. La T nera disegnata sul fondo della vasca a 2 metri dal bordo
- [ ] D. La T nera disegnata sul fondo della vasca a 1 metro dal bordo

## 527 - La scuola nuoto

**Quale tra i seguenti elementi può influenzare maggiormente l’efficacia della nuotata a farfalla?**
...
**Quale tra i seguenti non è un obiettivo della ginnastica educativa e prenatatoria?**

- [x] A. Apprendimento delle componenti gestuali delle nuotate
...
**Quale, fra queste distanze gara, non è prevista dal regolamento federale?**

- [ ] A. Staffetta 4x100 metri stile libero
- [ ] B. Staffetta 4x200 metri stile libero
- [x] C. Staffetta 4x400 metri stile libero
- [ ] D. Staffetta 4x100 metri mista

## 530 - La scuola nuoto

**Quali accorgimenti vanno adottati per svolgere in sicurezza la prima lezione in acqua alta?**
...
- [x] D. Usare 5/6 metri di corsia, rimanere fuori dall’acqua e non perdere di vista il gruppo.
...
**Quali delle seguenti norme vanno tenute in considerazione nella gestione di un centro natatorio?**
...
**Quali di questi errori è più grave e quindi va corretto prima?**

- [ ] A. Un errore di traiettoria della mano sott’acqua
- [ ] B. Una battuta di gambe deficitaria
- [x] C. Un errore di ritmo respiratorio
- [ ] D. Un errore nel recupero

## 534 - La scuola nuoto

**Quali fra i seguenti fattori di rischio attengono direttamente alla responsabilità dell’istruttore?**
...
**Quali possono essere le finalità di una scuola nuoto federale?**

- [x] A. Ricreativa, agonistica, didattica
...
**Quali sono gli obiettivi dell’educazione respiratoria?**

- [ ] A. Ristrutturazione dei sistemi di riferimento
- [x] B. Controllo dell’apnea e degli scambi respiratori
- [ ] C. Immersione del corpo in acqua
- [ ] D. Far trascorrere i primi minuti di lezione

## 537 - La scuola nuoto

**Quali sono i benefici della ginnastica educativa e prenatatoria?**

- [x] A. Sviluppa le capacità motorie, eleva il tono funzionale di base dei sistemi organici centrali, prepara le strutture muscolare e articolare e stimola lo sviluppo di alcune caratteristiche delle diverse aree della personalità
...
**Quali sono le caratteristiche sport-specifiche del nuoto sincronizzato?**

- [x] A. Forza, resistenza, mobilità articolare
...
**Quali sono le cause più frequenti di incidente in piscina?**

- [x] A. Cadute, urti, affondamenti
...
**Quali sono le dimensioni di una vasca indoor per il nuoto?**
...
**Quali sono le distanze di gara a dorso in vasca da 25m?**
...
**Quali sono le distanze di gara a rana in vasca da 25m?**
...
**Quali sono le distanze olimpiche nel dorso?**
...
**Quali sono le fasi della programmazione in ordine corretto?**

- [x] A. Analisi della situazione - Definizione dell’obiettivo - Scelta dei metodi - Verifica dei risultati
...
**Quali sono le parti del corpo coinvolte nella propulsione della gambata a rana?**

- [ ] A. Piede
- [ ] B. Coscia - gamba – piede
- [ ] C. Gamba-piede
- [x] D. Piede - caviglia - gamba

## 546 - La scuola nuoto

**Quali sono le principali caratteristiche della bracciata a rana?**

- [ ] A. Presa e Trazioni veloci, Recupero lento
- [ ] B. Presa veloce, Trazione e Recupero lento
- [x] C. Presa e Trazione in accelerazione, Recupero veloce e scivolamento
- [ ] D. Presa, Trazione e Recupero alla stessa velocità

## 547 - La scuola nuoto

**Quali sono le principali tecniche di trasporto del pericolante?**
...
- [x] D. Nuotatore stanco, presa al petto, presa al capo, trasporto laterale

## 548 - La scuola nuoto

**Quali sono, nel giusto ordine, le fasi della bracciata a rana?**

- [ ] A. Presa, trazione, spinta, recupero
- [ ] B. Presa, spinta, recupero
- [x] C. Presa, trazione, recupero
- [ ] D. Trazione, spinta, recupero

## 549 - La scuola nuoto

**Quali tra i seguenti è un obiettivo di un corso di nuoto?**

- [x] A. Lo sviluppo di capacità senso- percettive e coordinative
...
**Quali tra i seguenti obiettivi formativi fanno parte della fase di ambientamento?**

- [ ] A. Respirazione a crawl con bracciate elementari e battuta di gambe
- [x] B. Respirazioni e forme elementari di propulsione
- [ ] C. Tuffo di testa dal blocco
- [ ] D. Virate tecniche a crawl e dorso

## 551 - La scuola nuoto

**Quali tra quelli elencati non sono criteri di selezione?**

- [ ] A. Fattori antropometrici ed ereditari
- [ ] B. Fattori coordinativo- cognitivi
- [x] C. Fattori termoregolatori
- [ ] D. Capacità di apprendimento rapido

## 552 - La scuola nuoto

**Quando è opportuno insegnare la respirazione laterale a stile libero?**

- [ ] A. Quando l’allievo ha imparato la nuotata completa
- [x] B. Quando l’allievo ha imparato la bracciata in forma grezza
- [ ] C. Subito, durante la didattica della bracciata
- [ ] D. In qualsiasi momento

## 553 - La scuola nuoto

**Quando proporre il tuffo?**

- [x] A. Quando l’allievo immerge il capo
...
**Quando s’inserisce la respirazione nella bracciata a rana?**

- [ ] A. Alla fine della spinta
- [ ] B. Durante la spinta
- [x] C. Alla fine della trazione
- [ ] D. All’inizio della trazione

## 555 - La scuola nuoto

**Quando si può ritenere che la fase dell’ambientamento sia superata?**

- [ ] A. Appena l’allievo ha acquisito una buona padronanza dell’acqua.
- [ ] B. Quando l’allievo si sa tuffare
- [x] C. Quando l’allievo galleggia sul petto e sul dorso, affonda e si sa spostare con il corpo rilassato
...
- [x] D. In ambienti eccessivamente caldi

## 557 - La scuola nuoto

**Quante sono le fasi della bracciata a stile libero? #####**
...
**Quanti giocatori della stessa squadra sono in campo contemporaneamente durante una partita di pallanuoto ufficiale? #####**
...
**Respirazione terrestre ed acquatica differiscono principalmente**
...
- [x] D. Perché l’espirazione è forzata in quanto deve vincere la maggior pressione dell’acqua

## 560 - La scuola nuoto

**Riscaldamento, rinforzo lezione precedente, introduzione nuove proposte, attivazione, nucleo aerobico, recupero (o defaticamento) e rinforzo sono**
...
- [x] D. Le fasi della singola lezione per gruppi di scuola nuoto evoluti; e la loro applicazione costante nelle lezioni favorisce la concatenazione degli stimoli, lezione dopo lezione, unitamente all’applicazione dei principi di gradualità e progressività

## 561 - La scuola nuoto

**Scoperta, conoscenza e consolidamento sono**

- [ ] A. Funzioni del sistema nervoso
- [ ] B. Capacità coordinative speciali
- [ ] C. Caratteristiche dell’intelletto
- [x] D. Fasi dell’apprendimento

## 562 - La scuola nuoto

**Se un allievo non ha ancora acquisito la corretta posizione di scivolamento prono e supino, è corretto introdurre le prime propulsioni degli arti inferiori?**

- [ ] A. Sì, perché in tal modo si aiuta il galleggiamento
- [ ] B. Dipende se la lezione si svolge in acqua alta o in acqua bassa
- [x] C. No, perché molto probabilmente l’azione delle gambe sarà eseguita scorrettamente
- [ ] D. Sì, ma solo con i bambini al di sotto dei 6 anni

## 563 - La scuola nuoto

**Se un atleta iscritto nella gara dei 100 metri stile libero nuota a rana in che sanzione incorre?**
...
**Se un bambino non ha assimilato bene la posizione di scivolamento prona e supina, possiamo ugualmente insegnare la battuta di gambe?**

- [ ] A. Si, perché così aiutiamo il galleggiamento
- [x] B. No perché altrimenti la battuta di gambe sarà tecnicamente errata
- [ ] C. Sì ma solo con i bambini molto piccoli
- [ ] D. Dipende se siamo in vasca piccola o in vasca grande

## 565 - La scuola nuoto

**Sono esercizi per imparare a controllare la respirazione**
...
- [x] D. Soffiare con il naso, tenere il fiato per 10 secondi in immersione, prendere aria dalla bocca e soffiarla dal naso, eseguire 20 respirazioni in immersione

## 566 - La scuola nuoto

**Sono esercizi per imparare a galleggiare**

- [ ] A. Immersione completa, immersioni con aiuti, immersioni in semicapovolta, raccolta di oggetti sul fondo
- [x] B. Stare fermi in posizione verticale, stare fermi in posizione raggruppata, stare fermi in posizione rovesciata, passare da una posizione ad un’altra senza fare sforzi
...
**Sono esercizi per imparare a immergersi**

- [ ] A. Gioco dei nomi, ricognizioni della vasca, esercizi di movimento in vasca piccoli, spostamenti lungo il bordo
- [x] B. Immersione completa, immersioni con aiuti, immersioni in semicapovolta, raccolta di oggetti sul fondo
...
**Sono esercizi per imparare a spostarsi in acqua**

- [ ] A. Immersione completa, immersioni con aiuti, immersioni in semicapovolta, raccolta di oggetti sul fondo
- [x] B. Arrivare ad un punto con la spinta dal bordo, arrivare alla corsia a sole gambe, scivolare sul dorso, usare braccia e gambe per raggiungere un punto, nuotare 25 m a gambe dorso
- [ ] C. Saltare in acqua, riprodurre una posizione in aria, tuffarsi da posizione in ginocchio, tuffarsi di testa

## 569 - La scuola nuoto

**Sono esercizi per imparare a tuffarsi**
...
- [x] D. Saltare in acqua, riprodurre una posizione in aria, tuffarsi da posizione in ginocchio, tuffarsi di testa

## 570 - La scuola nuoto

**Sono esercizi per l’accoglienza**

- [x] A. Gioco dei nomi, ricognizioni della vasca, esercizi di movimento in vasca piccoli, spostamenti lungo il bordo
...
**Sono esercizi per la sensopercezione in acqua**

- [ ] A. Immersione completa, immersioni con aiuti, immersioni in semicapovolta, raccolta di oggetti sul fondo
- [x] B. Aprire gli occhi sott’acqua, sentire sott’acqua, toccare il compagno e copiare la posizione
...
**Sono obiettivi intermedi dell’ambientamento**
...
- [x] D. Accoglienza, percepire in acqua, controllare la respirazione, controllare il galleggiamento, sapersi immergere,sapersi spostare, saltare in acqua e tuffarsi

## 573 - La scuola nuoto

**Su quali distanze, in vasca da 50 metri, possono essere ottenuti primati nazionali nella disciplina dei misti individuali?**
...
- [x] D. Consente di elevare il tono muscolare e di preparare le strutture periferiche all’attività natatoria

## 576 - La scuola nuoto

**Un esercizio è in forma competitiva**
...
- [x] C. Quando il fine dell’azione non è l’azione stessa ma la gratificazione ottenuta con la vittoria
- [ ] D. Lo deve sempre essere

## 577 - La scuola nuoto

**Un esercizio è in forma di gioco**

- [ ] A. Quando si propone un problema motorio e l’allievo deve trovare il modo di risolverlo
- [x] B. Quando il fine dell’azione non è l’azione stessa ma uno di contenuto ludico
- [ ] C. Quando il fine dell’azione non è l’azione stessa ma la gratificazione ottenuta con la vittoria
- [ ] D. Lo deve sempre essere

## 578 - La scuola nuoto

**Un esercizio è in forma di situazione problema quando**

- [x] A. Quando si propone un problema motorio e l’allievo deve trovare il modo di risolverlo
- [ ] B. Quando il fine dell’azione non è l’azione stessa ma uno di contenuto ludico
- [ ] C. Quando il fine dell’azione non è l’azione stessa ma la gratificazione ottenuta con la vittoria
- [ ] D. Lo deve sempre essere
...
**Un esercizio è riuscito quando**

- [ ] A. È stato provato da tutti
- [x] B. È riproducibile da tutti ogni volta che viene richiesto
- [ ] C. È stato eseguito dai migliori del gruppo
- [ ] D. Permette di conseguire un brevetto tecnico

## 580 - La scuola nuoto

**Un esperto nuotatore può esercitare funzioni di assistente bagnanti senza avere conseguito il titolo specifico?**
...
**Un nuotatore viene squalificato se**

- [ ] A. Nuotando a stile libero effettua due colpi di gambe a delfino dopo la virata
- [x] B. Dopo la partenza a dorso non riemerge entro i 15 metri
...
**Una piscina per poter ospitare manifestazioni agonistiche della FIN deve**

- [ ] A. Essere affiliata
- [ ] B. Essere promossa
- [ ] C. Essere confortevole
- [x] D. Essere omologata
